    ...
    <div className='px-[10%]  mt-[130px]'>
      ...
      <div className=" mt-20  flex flex-col gap-4">
        ...
        <div className=" mt-[-54px]   flex items-center justify-end text-[45px] font-semibold gap-20 ">
          <Link to= {"/"} className='hover:bg-white hover:text-[#db4444] hover:border border border-[#db4444] duration-300 text-[15px] bg-[#db4444] text-white px-7 py-2 rounded-[4px] ' >See All</Link>
