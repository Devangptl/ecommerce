...
import { addToCart, decreaseItemQuantity, removerItem } from "../features/cartSlice";
    ...
    <div className="2xl:container mt-[3%] 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          ...
          <button onClick={()=>dispatch(addToCart(data?.[0]))} className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">
            Add to Cart
          </button>
        </div>
